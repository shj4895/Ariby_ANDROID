...
import com.el.ariby.ui.main.menu.club.ClubSearchAdapter;

import java.util.ArrayList;

public class FollowAdapter extends BaseAdapter implements Filterable {
    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<FollowItem> FollowItemList = new ArrayList<FollowItem>();
    private ArrayList<FollowItem> filteredItemList = FollowItemList;
    ...
    // "custom_follow_list" Layout을 inflate하여 convertView 참조 획득.
        ...
        FollowItem followItem = filteredItemList.get(position);
        // 아이템 내 각 위젯에 데이터 반영
        iconImageView.setImageDrawable(followItem.getIconDrawable());
        titleTextView.setText(followItem.getNick());
        descTextView.setText(followItem.getDescStr());
        return convertView;
